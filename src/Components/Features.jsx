...
import spec1 from '../assets/specs1.png'

export default function Features() {
    return (
        <>
            <div>
                <h1 className="text-red-500 uppercase text-4xl md:text-6xl text-center font-bold -mb-16 mt-8 dark:text-white">Features</h1>
                <div className="flex flex-col md:flex-row items-center mt-10 md:mt-20 mx-auto px-4 md:px-20">
                    ...
                    <div className="md:w-1/2 mt-8 md:mt-0 md:pl-8 px-4 md:px-2">
                        <div
                            className="relative mb-4"
                            data-aos="fade"
                        >
                            <h1 className="text-2xl md:text-4xl font-bold mt-2 text-center md:text-left dark:text-white">Uifry Premium</h1>
                        </div>
